      ...
      <div className="px-4 pt-24 md:px-8 lg:px-16 xl:px-32 2xl:px-64">
        ...
        <div className="flex flex-col md:flex-row bg-white rounded-lg overflow-hidden">
          ...
          <div className="w-full md:w-1/2 p-8">
            ...
            <p className="text-gray-600 mb-4">We are at your service.</p>
            <div className="text-gray-700">
              <p className="mb-8">
                <strong className='p-2'><PlaceIcon className='contact-icon' /></strong>
              ...
              <p className="mb-8">
                <strong className='p-2'><PhoneIcon className='contact-icon' /></strong>
                <a href="tel:+18324416021" className="text-hovr hover:text-button">+1 (832) 441 6021</a>
              </p>
              <p className="mb-8">
                <strong className='p-2'><WhatsAppIcon className='contact-icon' /></strong>
                <a href="https://wa.me/+18324416021" target="_blank" rel="noopener noreferrer" className="text-hovr hover:text-button">+1 (832) 441 6021</a>
              </p>
              <p className="mb-8">
                <strong className='p-2'><EmailIcon className='contact-icon' /></strong>
                <a href="mailto:Johanna@bespokequince.com" className="text-hovr hover:text-button">Johanna@bespokequince.com</a>
              </p>
            </div>
          </div>
        </div>
