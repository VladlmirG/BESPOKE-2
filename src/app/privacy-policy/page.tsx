...
<head>
    ...
    <div className='px-4 pt-24 md:px-8 lg:px-16 xl:px-32 2xl:px-64 relative'>
        <div>
          ...
          <p>Bespoke XV & Formal runs <strong><a href="https://bespokequince.com/">bespokequince.com.</a></strong>  This portal aims to inform you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.
          ...
          <ul>
            ...
            <li>To contact and follow up with you regarding inquiries email or phone.</li><br/>
          </ul>
          ...
          <p>Cookies are files with small amount of data, which may include an anonymous unique identifier, sent to your browser from a web site and stored on your computer's hard drive for record-keeping purposes.

           Cookies are a common industry standard and like many sites, we use cookies to collect information. Using cookies helps us: remember user 's visits, understand and save user preferences for future visits, keep track of advertisements, compile aggregate data about site traffic and site interactions in order to offer better site experiences and tools in the future. We may also use trusted third-party services that track this information on our behalf. You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use our site at it's full extend.
          </p><br/><br/>

          <h4 className='text-xl font-bold mb-4'>Links To Other Websites</h4>
          <p>Our Site may contain links to other websites, including those of sponsors and advertisers, whose information practices may be different from ours. Sometimes these third party websites might conduct contests or any other activity that are promoted on our Website. Visitors should consult those other third party websites' privacy notices, since those websites are not covered by our privacy policy and may follow different procedures.
          </p><br/><br/>

          <h4 className='text-xl font-bold mb-4'>Security</h4>
          <p>Securing your Personal Information is important to us, but keep in mind that no method of transmission over the Internet, or procedure of electronic storage, is 100% secure. While we strive to use commercially acceptable means to protect your Personal Information, we cannot guarantee its absolute security.
          </p><br/><br/>

          <h4 className='text-xl font-bold mb-4'>Changes To This Privacy Policy</h4>
          <p>We may modify this Privacy Policy from time to time.
           ...
           If we make any changes to this Privacy Policy, we will notify you either through the email address you may have provided us, or by placing a prominent notice on our website.
          </p><br/><br/>
        </div>
      </div>
      </>
